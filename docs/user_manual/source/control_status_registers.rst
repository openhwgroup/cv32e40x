...
.. only:: ZC
  ...
  .. table:: Control and Status Register Map (additional CSRs for Zc* extensions)
    :name: Control and Status Register Map (additional CSRs for Zc* extensions)
    +---------------+-------------------+-----------+---------------------+---------------------------------------------------------+
    |  CSR Address  |   Name            | Privilege | Parameter           |  Description                                            |
    +===============+===================+===========+=====================+=========================================================+
    | Zc* CSRs                                                                                                                      |
...
|   Bit #     |   Mode     |           Description                                                 |
+=============+============+=======================================================================+
| 31 : 6      |   RW       | **Address**: Trap-handler vector table base address, 64 byte aligned. |
+-------------+------------+-----------------------------------------------------------------------+
...
This register holds the active machine mode interrupt level threshold.
